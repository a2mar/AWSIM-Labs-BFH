...
public class BezierRoadManager : MonoBehaviour
{
    ...
    public float secundaryScatteringRange = 0f;
    ...
    /// <summary>
    /// Randomize Bezier end knots based on the probability for randomization
    /// </summary>
    ...
    Vector3[] UpdatedCubicBezierKnots(int segment)
    {

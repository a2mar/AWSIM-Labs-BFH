...
public class BezierRoadMesh : MonoBehaviour
{
    ...
    /// <summary>
    /// Creates a road segmennt with mesh, mesh filter, mesh renderer, box-colliders, and trigger colliders
    /// from the provided points for the left and right side of a road.
    /// </summary>
    /// <param name="leftPoints">Array of vectors for the left side of the road segment</param>
    /// <param name="rightPoints">Array of vectors for the right side of the road</param>
    ...
    void AssignMeshComponents()
    {
        ...
        // automatically search for "xyz.mat" in Resources
        if (roadMaterial == null)
        {
            roadMaterial = Resources.Load<Material>("Materials/BezierRoad/Road-AS-2L-smth");
